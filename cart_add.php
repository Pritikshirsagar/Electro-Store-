<?php
    ...
    $add_to_cart_query="insert into tbl_cart(user_id,username,product_id,product_name,img,price,quantity,total,shipping,date) values ('$user_id','$username','$item_id','$pname','$img','$price','$qty','$total','$shipping','$date')";
