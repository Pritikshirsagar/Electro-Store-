<?php 
	...
	//	$sid=$_POST['Supplier_ID'];
	  $userid = $_SESSION['supplier_id']; 
		...
		//echo $name;
		$sql="insert into tbl_supplier_product(supplier_id,Supplier_Name,pname,category_name,sub_cat,description,Quantity,Price,Total,Email_ID,Mobile_No,Address) values('$userid','$sname','$pname','$sub','$category','$dec','$quantity','$price','$total','$Email','$mobileno','$address')";
		//echo $sql."<br>";
