		...
		<!--content-->
			<div class="content">
				<div class="products-agileinfo">
						<h2 class="tittle">Men's Watch</h2>
					<div class="container">
								...
								<div class="top-rates">
									...
									<div class="recent-grids">
										...
										<div class="recent-right">
											<h6 class="best2"><a href="single.html">Top</a></h6> 
											<p><del>400.00</del> <em class="item_price">300.00</em></p>
										</div>	
...
<div class="clearfix"></div>	
  ...
  <div class="row">
	<?php 
	$sql="select * from tbl_product where category='Mens Watch'"; 
