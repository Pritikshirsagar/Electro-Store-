  ...
  <br>
   <div class="container">
			<div class="row pad-botm">
				<div class="col-md-12">
					<h4 class="header-line">supplier\<a href="manage_supplier.php">Bank Details</a></h4>
				</div>
			</div>
     ...
     $sql="select * from tbl_supplier_bank_details";
	...
	{       
        while($row = mysqli_fetch_array( $result )) {	?>
			...
			<tr class="odd gradeX">
                           ...
                           <td class="center" align="center">s<?php echo $row['S_B_id'];?></td>
