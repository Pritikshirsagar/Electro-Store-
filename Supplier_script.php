<?php
    ...
    //echo $email;
    $password_from_database_query="select password from tbl_supplier where supplier_id='$id'";
	...
	{
        $update_password_query="update tbl_supplier set password='$new_password' where supplier_id='$id'";
      ...
      //  echo "Your password has been updated.";
        ...
        <meta http-equiv="refresh" content="1;url=supplier_Changepassword.php" />
        <?php
