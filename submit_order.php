...
$result=$con->query($sql1);
	...
	$date=date('d/m/y');
	 ...
	 $add_to_order_query="insert into tbl_order(user_id,username,product_id,product_name,img,price,qty,total,ship_name,mobile_no,landmark,city,add_type,status,shipping,date,payment_mode) values ('$uid','$uname','$pid','$pname','$img','$price','$qty','$total','$shipname','$number','$landmark','$city','$op','$type','$shipping','$date','$mode')";
...
echo "<script>alert('please collect your Receipt from Your Account')</script>";
