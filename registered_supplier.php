...
<body>
	<!--header-->
		...
		<div class="banner1">
			<div class="container">
				<h3><a href="index.html">Home</a> / <span> Supplier Register</span></h3>
			</div>
		</div>
	<!--banner-->
	...
	<!--content-->
		...
		<div class="main-agileits">
				<div class="form-w3agile form1">
					...
					<form action="reg_Supplier_DB.php" method="post">
					<h3>Supplier Register</h3>
						<div class="form-group">
							<label class="col-form-label">First Name</label>
							<input type="text" class="form-control" placeholder="Enter First Letter Capital eg.Ram " name="supplier_fname" required="">
						</div>
						<div class="form-group">
							<label class="col-form-label">Last Name</label>
							<input type="text" class="form-control" placeholder="Enter  First Letter Capital eg.Joshi" name="supplier_lname" required="">
						</div>
						<div class="form-group">
