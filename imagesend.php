...
session_start();
  ...
  $pathToImage = "images/i10.jpg";    // TODO: Replace it with the path to your image
  $imageData = file_get_contents($pathToImage);
  $base64Image = base64_encode($imageData);

  $postData = array(
    'number' => '919527495733',  // TODO: Specify the recipient's number (NOT the gateway number) here.
    'image' => $base64Image,
    'caption' => 'Lovely Dress'
  );
